...
public class UtilController {
	...
	public String uploadBase64(HttpServletRequest request, HttpServletResponse response,@RequestBody DownloadDto base64) throws ParseException, IOException {
		return utilService.uploadBase64(response,base64);
	}
}